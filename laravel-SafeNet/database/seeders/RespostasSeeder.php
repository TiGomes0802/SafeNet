...
class RespostasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $respotas = [
          ...
          ["resposta" => "Recolha de informação", "certa" => 1, "idJogo" => 3],
          ["resposta" => "Engano elaborado", "certa" => 2, "idJogo" => 3],
          ["resposta" => "Execução do ataque", "certa" => 3, "idJogo" => 3],
          ...
          ["resposta" => "Envio do email de phishing", "certa" => 1, "idJogo" => 6],
          ["resposta" => "Clicar no link e inserir dados", "certa" => 2, "idJogo" => 6],
          ["resposta" => "Roubo das credenciais", "certa" => 3, "idJogo" => 6],
          ...
          ["resposta" => "Phishing", "certa" => 1, "idJogo" => 9],
          ["resposta" => "Vishing", "certa" => 2, "idJogo" => 9],
          ["resposta" => "Tailgating", "certa" => 3, "idJogo" => 9],
          ...
          ["resposta" => "Phishing genérico", "certa" => 1, "idJogo" => 12],
          ["resposta" => "Phishing dirigido (spear phishing)", "certa" => 2, "idJogo" => 12],
          ["resposta" => "Pretexting com múltiplas interações", "certa" => 3, "idJogo" => 12],
          ...
          ["resposta" => "Evitar responder", "certa" => 1, "idJogo" => 15],
          ["resposta" => "Reportar à equipa responsável", "certa" => 2, "idJogo" => 15],
          ["resposta" => "Informar os colegas", "certa" => 3, "idJogo" => 15],
          ...
          ["resposta" => "Desconfiar de urgências", "certa" => 1, "idJogo" => 18],
          ["resposta" => "Verificar remetentes", "certa" => 2, "idJogo" => 18],
          ["resposta" => "Reportar incidentes", "certa" => 3, "idJogo" => 18]
        ];
