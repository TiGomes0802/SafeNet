          ...
          <div class="w-full lg:w-1/2">
            ...
            <div class="max-h-[448px] overflow-y-auto"> <!-- 7 linhas * ~64px por linha = 448px -->
              <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <tbody>
                  <tr v-for="(pedido, index) in storeAmigo.pedidos.pedidosRecebidos" :key="pedido.id"
            ...
            <div class="flex flex-col w-full mt-3">
              <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-5 mb-2">
                <div class="w-full sm:w-4/6">
                  <input type="text" v-model="username" placeholder="Escreve o username do teu amigo"
                    class="w-full border p-2 rounded" />
                </div>
                <div class="w-full sm:w-2/6">
                  <button @click="adicionarAmigo" :disabled="!loadingAdicionar"
          ...
          <div class="w-full lg:w-1/2">
            ...
            <div class="max-h-[448px] overflow-y-auto">
              <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <tbody>
                  <tr v-for="pedido in storeAmigo.pedidos.pedidosEnviados" :key="pedido.id"
                    class="border-t hover:bg-gray-50">
                    <td class="px-6 py-4">{{ pedido.nome }}</td>
                    <td class="px-6 py-4">{{ pedido.username }}</td>
                  </tr>
