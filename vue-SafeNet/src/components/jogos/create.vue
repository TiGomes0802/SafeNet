...
<template>
    <div class="flex">
        <Sidebar />
        <div
            class="flex-1 px-4 pt-6 sm:px-6 md:px-9 md:pt-7 lg:px-12 lg:pt-9 xl:px-16 xl:pt-10 bg-gray-200 w-screen h-screen overflow-y-scroll">
            <h1 class="text-3xl font-bold mb-4">Criar Pergunta</h1>

            <div class="mb-4">
                <label class="block font-semibold mb-1">Tipo de Pergunta:</label>
                <select v-model="tipoJogo"
