        ...
        <div class="flex h-screen">
            ...
            <div :class="['flex-1 bg-gray-100 p-6 overflow-y-scroll transition-all duration-300', dynamicPadding]">
                <form @submit.prevent="submeterFormulario"
                    class="w-full max-w-xl mx-auto bg-white p-8 rounded-xl shadow">
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.email" type="email"
                            class="w-full px-4 py-2 border rounded bg-gray-100 cursor-not-allowed" disabled />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="form.password" type="password" class="w-full px-4 py-2 border rounded"
                            placeholder="Deixar vazio se não quiser mudar" />
                    </div>

                    <div class="mb-4">
                        <label class="block mb-1 font-medium text-gray-700">Confirmar Password</label>
                        <input v-model="form.password_confirmation" type="password"
                            class="w-full px-4 py-2 border rounded" placeholder="Confirmar nova password" />
                        <p v-if="erros.password_confirmation" class="text-red-600 text-sm mt-1">{{
                            erros.password_confirmation }}</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <img v-if="previewFoto" :src="previewFoto" alt="Preview"
                            class="w-24 h-24 mt-4 rounded-full object-cover border" />
                    </div>

                    <div class="mt-6">
                        <button type="submit"
                            class="bg-blue-600 text-white font-semibold py-2 px-4 rounded w-full hover:bg-blue-700 transition"
